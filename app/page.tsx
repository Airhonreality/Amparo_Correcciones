    ...
    <>
      ...
      <div className="bg-cream overflow-hidden">
        <div className="mx-auto max-w-6xl px-6 sm:px-8 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center py-14 sm:py-16 lg:h-[calc(100vh-4rem)] lg:py-6">

            {/* Bloque de Texto (7 Columnas) */}
            <div className="col-span-1 lg:col-span-7 flex flex-col justify-center gap-5 text-left bg-blue-pastel px-8 lg:px-12 py-10 lg:py-12 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
              <h1 className="font-display text-4xl font-bold tracking-tight text-ink leading-[1.15] sm:text-5xl lg:text-6xl">
                Su texto está en buenas manos.
              </h1>
              <p className="max-w-xl text-lg sm:text-xl font-medium leading-relaxed text-ink">
            ...
            <div className="col-span-1 lg:col-span-5 relative hidden lg:flex items-center justify-center">
              <div className="relative w-full max-w-md">
                {/* 1. El Arco (animación de eventos) */}
                <div className="aspect-[4/5] w-full rounded-tr-full rounded-tl-full overflow-hidden shadow-xl border-4 border-white/50 bg-white">
                  <EventsCarousel />
                </div>

                {/* 2. El Cameo (Retrato superpuesto) */}
                <div className="absolute -left-8 bottom-8 flex flex-col items-center gap-3">
                  <div className="w-36 h-36 shrink-0 rounded-full overflow-hidden shadow-2xl border-[6px] border-cream relative z-10">
                    <img
